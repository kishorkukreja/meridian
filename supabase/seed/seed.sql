...
INSERT INTO objects (user_id, name, description, module, category, region, source_system, current_stage, status, owner_alias, team_alias, notes) VALUES
-- Master Data
...
INSERT INTO issues (user_id, object_id, title, description, issue_type, lifecycle_stage, status, owner_alias, raised_by_alias, blocked_by_note, decision) VALUES
-- Issues for OBJ-DP-MD-002 (Customer hierarchy - stuck at mapping)
('USER_ID_HERE', (SELECT id FROM objects WHERE name = 'OBJ-DP-MD-002'), 
...
('USER_ID_HERE', (SELECT id FROM objects WHERE name = 'OBJ-DP-MD-004'), 
...
('USER_ID_HERE', (SELECT id FROM objects WHERE name = 'OBJ-DP-DR-002'), 
...
('USER_ID_HERE', (SELECT id FROM objects WHERE name = 'OBJ-SP-P1-002'), 
...
('USER_ID_HERE', (SELECT id FROM objects WHERE name = 'OBJ-DP-MD-001'), 
